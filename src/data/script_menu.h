...
{
    {COMPOUND_STRING("NORMAL FORME")},
    {COMPOUND_STRING("ATTACK FORME")},
    {COMPOUND_STRING("DEFENSE FORME")},
    {COMPOUND_STRING("SPEED FORME")},
    {gText_Exit},
};
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_DEOXYS_FORMS]               = MULTICHOICE(MultichoiceList_DeoxysFormes),
};
