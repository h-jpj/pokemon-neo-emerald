...
const u8 gMonFootprint_QuestionMark[] = INCBIN_U8("graphics/pokemon/question_mark/footprint.1bpp");
...
#if P_MEGA_EVOLUTIONS
    const u32 gMonFrontPic_GyaradosMega_Y[] = INCBIN_U32("graphics/pokemon/gyarados/mega_y/front.4bpp.lz");
    const u32 gMonPalette_GyaradosMega_Y[] = INCBIN_U32("graphics/pokemon/gyarados/mega_y/normal.gbapal.lz");
    const u32 gMonBackPic_GyaradosMega_Y[] = INCBIN_U32("graphics/pokemon/gyarados/mega_y/back.4bpp.lz");
    const u32 gMonShinyPalette_GyaradosMega_Y[] = INCBIN_U32("graphics/pokemon/gyarados/mega_y/shiny.gbapal.lz");
    const u8 gMonIcon_GyaradosMega_Y[] = INCBIN_U8("graphics/pokemon/gyarados/mega_y/icon.4bpp");
    ...
    const u32 gMonShinyPalette_RelicanthMega[] = INCBIN_U32("graphics/pokemon/relicanth/mega/shiny.gbapal.lz");
    const u8 gMonIcon_RelicanthMega[] = INCBIN_U8("graphics/pokemon/relicanth/mega/icon.4bpp");
#endif //P_MEGA_EVOLUTIONS
