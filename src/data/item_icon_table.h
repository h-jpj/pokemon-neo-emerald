const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_RELICANTHITE] = {gItemIcon_Dewgongite, gItemIconPalette_Dewgongite},
    [ITEM_MILOTICITE] = {gItemIcon_Miloticite, gItemIconPalette_Miloticite},
    [ITEM_SLOWKINGITE] = {gItemIcon_Slowbronite, gItemIconPalette_Slowbronite},
    [ITEM_GYARADOSITE_Y] = {gItemIcon_Gyaradosite, gItemIconPalette_Gyaradosite},
    ...
    [ITEM_POKEVIAL] = {gItemIcon_Flute, gItemIconPalette_BlueFlute},
    // Story Key Items
