...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNCUTSSPATTACKWITH]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} cuts {B_DEF_NAME_WITH_PREFIX2}'s Sp. Atk!"), //not in gen 5+, ability popup
    ...
    [STRINGID_TWISTEDDIMENSIONACTIVATED]            = COMPOUND_STRING("Dimensions have been twisted\n{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}!"),
    [STRINGID_AIRBLOWERACTIVATED]                   = COMPOUND_STRING("The winds have picked up\n{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}!"),
