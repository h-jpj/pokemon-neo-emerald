...
static const u8 sText_PkmnKindlingPower[] = _("{B_ATK_NAME_WITH_PREFIX} began\nkindling power!");
...
static const u8 sText_BattlerAbilitySetUpTrickRoom[] = _("Dimensions have been twisted\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}!");
static const u8 sText_BattlerAbilitySetUpTailWind[] = _("The winds have picked up\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNKINDLINGPOWER - BATTLESTRINGS_TABLE_START] = sText_PkmnKindlingPower,
    ...
    [STRINGID_PKMNCUTSSPATTACKWITH - BATTLESTRINGS_TABLE_START] = sText_PkmnCutsSpecialAttackWith,
