...
extern const u8 BattleScript_EffectBlastOff[];
...
extern const u8 BattleScript_AirBlowerRemoved[];
extern const u8 BattleScript_EffectFiredUp[];
...
extern const u8 BattleScript_EffectHipHoray[];
extern const u8 BattleScript_Exorcism[];
extern const u8 BattleScript_EffectPhaseShift[];
extern const u8 BattleScript_EffectFlirtyKiss[];
extern const u8 BattleScript_EffectPerseverance[];
...
extern const u8 BattleScript_EffectKindle[];
