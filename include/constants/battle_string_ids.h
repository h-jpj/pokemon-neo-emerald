...
#define STRINGID_PKMNKINDLINGPOWER                    708
#define STRINGID_PKMNMAKESWATERMISS                   709
#define STRINGID_TWISTEDDIMENSIONACTIVATED            710
#define STRINGID_AIRBLOWERACTIVATED                   711
